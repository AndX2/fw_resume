    ...
    return LayoutBuilder(builder: (context, cons) {
      ...
      return Stack(
        children: <Widget>[
          ...
          ClipPath(
            clipper: HeadClipper(shrinkScale: shrinkScale),
            child: Container(
...
class ShadowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // path.close();
    canvas.drawShadow(path, Colors.orange, 16.0, true);
  }
...
class HeadClipper extends CustomClipper<Path> {
  ...
  HeadClipper({@required this.shrinkScale});
  ...
  @override
  bool shouldReclip(HeadClipper oldClipper) {
    return true;
  }
}
